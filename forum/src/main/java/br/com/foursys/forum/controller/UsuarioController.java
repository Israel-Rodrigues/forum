...
/**
 * Classe responsavel por controlar o objeto Usuario.
 * 
...
public class UsuarioController {
	...
	@PostMapping
	public ResponseEntity<UsuarioDto> cadastrar(@RequestBody UsuarioForm formUser, UriComponentsBuilder uriBuilder) {
		Usuario usuario = formUser.converter(usuarioRepository);
